...
{
  "displayName": "Acquia Personalization Capture",
  "description": "Implement Event, Update Person, and Identity captures for Acquia Personalization with this GTM template.",
  "categories":["ANALYTICS","EXPERIMENTATION","MARKETING","PERSONALIZATION","CONVERSIONS"],
  "securityGroups": [],
...
[
  ...
  },
  {
    ...
    "subParams": [
      {
        "displayName": "This field must be configured in the column meta data table and mapped to a custom_field accessor such as event_udf1. Please reference https://docs.acquia.com/Personalization/profile-mgr/admin/column-meta-data/ for further help.",
        "name": "eventParams",
        "simpleTableColumns": [
          {
            "valueValidators": [
              {
                "type": "REGEX",
                "args": [
                  "^event_udf(5[0]|[1-4][0-9]|[1-9])$"
                ]
              }
            ],
            "defaultValue": "event_udf1",
    ...
    "help": "This field must be configured in the column meta data table and mapped to a custom_field accessor. Please reference https://docs.acquia.com/Personalization/profile-mgr/admin/column-meta-data/ for further help."
  },
  {
    ...
    "subParams": [
      {
        "displayName": "This field must be configured in the column meta data table and mapped to a custom_field accessor such as person_udf1. Please reference https://docs.acquia.com/Personalization/profile-mgr/admin/column-meta-data/ for further help.",
        "name": "updateParams",
        "simpleTableColumns": [
          {
            "valueValidators": [
  ...
  },
  {
    ...
    "subParams": [
      {
        "displayName": "When capturing events, you may want to directly send identifying visitor information to Acquia Personalization such as the website visitor’s email address, social media username, or an identifier from another system (such as a subscriber ID).",
        ...
        "help": "Reference https://docs.acquia.com/Personalization/api/javascript/identity/ for additional information."
      }
    ],
    "enablingConditions": [
      {
...
const PersonalizationQueuePush = createQueue('_tcaq');
...
const updateParams = data.updateParams;
    ...
    if (eventType == 'capture') {
     ...
     PersonalizationQueuePush([eventType, data.eventId, params]);
     data.gtmOnSuccess();
     ...
     PersonalizationQueuePush(['updatePerson', paramCus]);
     data.gtmOnSuccess();
   } else if (eventType == 'captureIdentity' && identityDefault != undefined) {
      identityDefault.forEach(
         function(item, index) {
           ...
           for (var key in paramDef) {
             ...
             PersonalizationQueuePush([eventType, key, paramDef[key]]);
         data.gtmOnSuccess();
           }
           }
           if (identityCustom) {
       ...
       updateParams.forEach(
        ...
        PersonalizationQueuePush([eventType, paramCus]);
      data.gtmOnSuccess();
           }
